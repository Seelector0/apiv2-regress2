...
class HttpMethod:
    ...
    def get(self, link: str, params=None):
        ...
        """
        with allure.step(title=f"GET requests to URL '{ENV_OBJECT.get_base_url()}/v2/{link}'"):
    ...
    def post(self, link: str, data=None, files=None):
        ...
        :return:
        """
        with allure.step(title=f"POST requests to URL '{ENV_OBJECT.get_base_url()}/v2/{link}'"):
            link = f"{ENV_OBJECT.get_base_url()}/v2/{link}"
    ...
    def patch(self, link: str, data=None):
        ...
        :param data: Тело запроса в формате JSON.
        """
        with allure.step(title=f"PATCH requests to URL '{ENV_OBJECT.get_base_url()}/v2/{link}'"):
            link = f"{ENV_OBJECT.get_base_url()}/v2/{link}"
    ...
    def put(self, link: str, data=None):
        ...
        :param data: Тело запроса в формате JSON.
        """
        with allure.step(title=f"PUT requests to URL '{ENV_OBJECT.get_base_url()}/v2/{link}'"):
            link = f"{ENV_OBJECT.get_base_url()}/v2/{link}"
    ...
    def delete(self, link: str):
        ...
        :param link: Ссылка на запрос.
        """
        with allure.step(title=f"DELETE requests to URL '{ENV_OBJECT.get_base_url()}/v2/{link}'"):
            link = f"{ENV_OBJECT.get_base_url()}/v2/{link}"

...
class ApiModerationDeliveryServices:
    ...
    def moderation_boxberry(self):
        ...
        result = self.admin.http_method.post(link=self.link, json=boxberry, admin=True, token=self.admin.admin_token())
        try:
            with allure.step(title=f"Response: {result.json()}"):
                return result
        except simplejson.errors.JSONDecodeError or requests.exceptions.JSONDecodeError:
    ...
    def moderation_cdek(self):
        ...
        result = self.admin.http_method.post(link=self.link, json=cdek, admin=True, token=self.admin.admin_token())
        try:
            with allure.step(title=f"Response: {result.json()}"):
                return result
        except simplejson.errors.JSONDecodeError or requests.exceptions.JSONDecodeError:
    ...
    def moderation_dpd(self):
        ...
        result = self.admin.http_method.post(link=self.link, json=dpd, admin=True, token=self.admin.admin_token())
        try:
            with allure.step(title=f"Response: {result.json()}"):
                return result
        except simplejson.errors.JSONDecodeError or requests.exceptions.JSONDecodeError:
    ...
    def moderation_five_post(self):
        ...
        result = self.admin.http_method.post(link=self.link, json=five_post, admin=True, token=self.admin.admin_token())
        try:
            with allure.step(title=f"Response: {result.json()}"):
                return result
        except simplejson.errors.JSONDecodeError or requests.exceptions.JSONDecodeError:
    ...
    def moderation_yandex_go(self):
        ...
        result = self.admin.http_method.post(link=self.link, json=yandex_go, admin=True, token=self.admin.admin_token())
        try:
            with allure.step(title=f"Response: {result.json()}"):
                return result
        except simplejson.errors.JSONDecodeError or requests.exceptions.JSONDecodeError:
    ...
    def moderation_dalli(self):
        ...
        result = self.admin.http_method.post(link=self.link, json=dalli, admin=True, token=self.admin.admin_token())
        try:
            with allure.step(title=f"Response: {result.json()}"):
                return result
        except simplejson.errors.JSONDecodeError or requests.exceptions.JSONDecodeError:

...
class ApiModerationDeliveryServices:
    ...
    def moderation_russian_post(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=russian_post, token=self.admin.admin_token(),
                                             admin=True)
    ...
    def moderation_topdelivery(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=topdelivery, token=self.admin.admin_token(),
                                             admin=True)
        with allure.step(title=f"Response: {result.json()}"):
            return result
    ...
    def moderation_boxberry(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=boxberry, token=self.admin.admin_token(),
                                             admin=True)
        with allure.step(title=f"Response: {result.json()}"):
            return result
    ...
    def moderation_cdek(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=cdek, token=self.admin.admin_token(),
                                             admin=True)
        with allure.step(title=f"Response: {result.json()}"):
            return result
    ...
    def moderation_dpd(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=dpd, token=self.admin.admin_token(), admin=True)
        with allure.step(title=f"Response: {result.json()}"):
            return result
    ...
    def moderation_five_post(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=five_post, token=self.admin.admin_token(),
                                             admin=True)
        with allure.step(title=f"Response: {result.json()}"):
            return result
    ...
    def moderation_yandex_go(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=yandex_go, token=self.admin.admin_token(),
                                             admin=True)
        with allure.step(title=f"Response: {result.json()}"):
            return result
    ...
    def moderation_dalli(self):
        ...
        result = self.admin.http_method.post(link=self.link, data=dalli, token=self.admin.admin_token(), admin=True)
        with allure.step(title=f"Response: {result.json()}"):
            return result

...
def shared_data():
    ...
    data = {
        ...
        "alemtat_i": delivery_template(),
        "boxberry_a": delivery_template(),
        "boxberry_i": delivery_template(),
        "cdek_a": delivery_template(),
        "cdek_i": delivery_template(),
        "cse_a": delivery_template(),
        "cse_i": delivery_template(),
        "dalli_a": delivery_template(),
        "dalli_i": delivery_template(),
        "dpd_a": delivery_template(),
        "dpd_i": delivery_template(),
        "halva_a": delivery_template(),
        "halva_i": delivery_template(),
        "l_post_i": delivery_template(),
        "metaship_a": delivery_template(),
        "kaz_post_a": delivery_template(),
        "kaz_post_i": delivery_template(),
        "five_post_a": delivery_template(),
        ...
        "pecom_i": delivery_template(),
        "pony_express_a": delivery_template(),
        "pony_express_i": delivery_template(),
        "yandex_delivery_a": delivery_template(),
        "yandex_delivery_i": delivery_template(),

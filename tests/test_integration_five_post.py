...
def test_info_vats(app, token):
    ...
    Checking.checking_json_key(response=result_info_vats, expected_value=OtherInfo.FIVE_POST_VATS.value)
...
def test_create_delivery_point(app, payment_type, token):
    result_order = app.order.create_order(payment_type=payment_type, type_ds="DeliveryPoint", service="FivePost",

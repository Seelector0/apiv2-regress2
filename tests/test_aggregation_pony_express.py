...
def test_integration_delivery_services(app):
    pony_express = app.service.post_delivery_service(delivery_service=app.settings.pony_express(aggregation=True))
...
def test_moderation_delivery_services(admin):
    moderation = admin.connection.post_connections(delivery_service=admin.moderation.pony_express())

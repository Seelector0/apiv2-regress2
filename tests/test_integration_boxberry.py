...
def test_integration_delivery_services(app, shop_id):
    boxberry = app.service.post_delivery_service(shop_id=shop_id, delivery_service=app.settings.boxberry())
...
def test_get_label_out_of_parcel(app, labels, shared_data):

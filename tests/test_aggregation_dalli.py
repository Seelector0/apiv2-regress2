...
def test_integration_delivery_services(app):
    dalli = app.service.post_delivery_service(delivery_service=app.settings.dalli(aggregation=True))
...
def test_moderation_delivery_services(admin):
    moderation = admin.connection.post_connections(delivery_service=admin.moderation.dalli())

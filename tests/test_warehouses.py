...
def test_get_warehouse_by_id(app, connections):
    random_warehouse_id = choice(connections.get_list_warehouses())
...
def test_delete_warehouse(app, connections):
    ...
    Checking.check_value_comparison(
        one_value=connections.get_list_warehouses_value(warehouse_id=random_warehouse_id, value="deleted"),
        two_value=[True])
